...
from runners.diffusion_mcj_mms_segy import Diffusion
...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--resume_training", default=True, help="Whether to resume training"
    )
    parser.add_argument(
        "-i",
        "--image_folder",
...
def main():
    ...
    args.siesmic_dir = '/home/shendi_mcj/datasets/seismic/marmousi'
    ...
    config.diffusion.beta_schedule = 'cosine' # 'cosine' "linear" "const" "jsd"  "sigmoid"
